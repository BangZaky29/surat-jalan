...
const CONFIG = {
    ...
    DEFAULT_FEATURE_SLUG: 'surat-jalan'
};
...
// =========================================
export const clearSubscriptionSession = (featureSlug = 'surat-jalan') => {
...
// =========================================
export const hasSubscriptionSession = (featureSlug = 'surat-jalan') => {
    try {
